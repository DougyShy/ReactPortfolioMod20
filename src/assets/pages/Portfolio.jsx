      ...
      <h1>Portfolios</h1>
        <div className="d-flex flex-row flex-wrap align-items-center p-3 justify-content-around">
          <div className="image-container">
            <img className="portfolio-image" src="src\assets\images\password.png" />
          ...
          <div className="image-container">
            <img className="portfolio-image" src="src\assets\images\logoMaker.png" />
            <div className="overlay">
          ...
          <div className="image-container">
            <img className="portfolio-image" src="src\assets\images\scheduler.png" />
            <div className="overlay">
        ...
        <div className="d-flex flex-row flex-wrap align-items-center p-3 justify-content-around">
          <div className="image-container">
            <img className="portfolio-image" src="src\assets\images\employeeTracker.png" />
            <div className="overlay">
          ...
          <div className="image-container">
            <img className="portfolio-image" src="src\assets\images\ecommerce.png" />
            <div className="overlay">
          ...
          <div className="image-container">
            <img className="portfolio-image" src="src\assets\images\social.png" />
            <div className="overlay">
